...
<body>
    ...
    <!-- Footer Content-->
    <!-- gonna add tree parts:
        1- copyright stuff
        2- links to our other pages
        3- social media
        4- 
    -->
    ...
    <footer>
        ...
        <div class="main">
            <div class="Rcard">
                <svg class="instagram" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <div class="Rcard">
                <svg class="twitter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30px" height="30px">
                    <path
            ...
            <div class="Rcard">
                <svg class="dribble" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="30px" height="30px">
                    <path
            ...
            <div class="Rcard">
                <svg class="codepen" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="30px" height="30px">
                    <path
            ...
            <div class="Rcard">
                <svg class="discord" height="30px" width="30px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div class="Rcard">
                <svg class="github" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px">
                    <path
            ...
            <div class="Rcard">
                <svg class="telegram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="30px" height="30px">
            ...
            <div class="Rcard">
                <svg class="reddit" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <g style="stroke: none; border-radius:50%; stroke-width: 0; stroke-dasharray: none; stroke-linecap: butt; stroke-linejoin: miter; stroke-miterlimit: 10; fill: none; fill-rule: nonzero; opacity: 1;"
        ...
        <div class="rights fWidth">
            <div class="copyright">© 2024 Sahla. All rigths reserved.</div>
            <div class="terms">

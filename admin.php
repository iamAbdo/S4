...
<body>
        ...
        <div id="Loc-data" class="container-data">
            <table>
                ...
                <tbody>
                    ...
                    $sqlQuery = "SELECT LocationID,Name,Description FROM locations LIMIT 10";
    ...
    <div class="container">
        <div class="container-title">
            Les Vols
            <div class="open-container">
                <svg onclick="OpenFlight()" id="FlightClosed" width="32px" height="32px" viewBox="0 0 24 24"
                    fill="none">
                    <path
                        d="M4 19V6.2C4 5.0799 4 4.51984 4.21799 4.09202C4.40973 3.71569 4.71569 3.40973 5.09202 3.21799C5.51984 3 6.0799 3 7.2 3H16.8C17.9201 3 18.4802 3 18.908 3.21799C19.2843 3.40973 19.5903 3.71569 19.782 4.09202C20 4.51984 20 5.0799 20 6.2V17H6C4.89543 17 4 17.8954 4 19ZM4 19C4 20.1046 4.89543 21 6 21H20M9 7H15M9 11H15M19 17V21"
                        stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <svg class="opener" onclick="CloseFlight()" id="FlightOpen" width="32px" height="32px"
        ...
        <div id="Flight-data" class="container-data">
            <table>
                <thead>
                    <tr>
                        <th>Flight ID</th>
                ...
                <tbody>
                    <?php
                    $sqlQuery = "SELECT F.FlightID, D.Name AS DepartureLocation, A.Name AS ArrivalLocation, 
                             F.DepartureDateTime, F.ArrivalDateTime, F.Price, F.Airline
                             FROM Flights F
                             JOIN Locations D ON F.DepartureLocationID = D.LocationID
                             JOIN Locations A ON F.ArrivalLocationID = A.LocationID
                             LIMIT 10";
                    $result = mysqli_query($conn, $sqlQuery);
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<td>$arrivalLocation</td>";
                            echo "<td>$departureDateTime</td>";
                            echo "<td>$arrivalDateTime</td>";
                            echo "<td>$price</td>";
                            echo "<td>$airline</td>";
                            echo '<td>
                                <a href="editFlight.php?id=' . $flightID . '">
                                    <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                    d="M21.2799 6.40005L11.7399 15.94C10.7899 16.89 7.96987 17.33 7.33987 16.7C6.70987 16.07 7.13987 13.25 8.08987 12.3L17.6399 2.75002C17.8754 2.49308 18.1605 2.28654 18.4781 2.14284C18.7956 1.99914 19.139 1.92124 19.4875 1.9139C19.8359 1.90657 20.1823 1.96991 20.5056 2.10012C20.8289 2.23033 21.1225 2.42473 21.3686 2.67153C21.6147 2.91833 21.8083 3.21243 21.9376 3.53609C22.0669 3.85976 22.1294 4.20626 22.1211 4.55471C22.1128 4.90316 22.0339 5.24635 21.8894 5.5635C21.7448 5.88065 21.5375 6.16524 21.2799 6.40005V6.40005Z"
                                    stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <a href="delete.php?type=' . $type . '&id=' . $flightID . '">
                                    <svg width="32px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                        d="M3 3L21 21M18 6L17.6 12M17.2498 17.2527L17.1991 18.0129C17.129 19.065 17.0939 19.5911 16.8667 19.99C16.6666 20.3412 16.3648 20.6235 16.0011 20.7998C15.588 21 15.0607 21 14.0062 21H9.99377C8.93927 21 8.41202 21 7.99889 20.7998C7.63517 20.6235 7.33339 20.3412 7.13332 19.99C6.90607 19.5911 6.871 19.065 6.80086 18.0129L6 6H4M16 6L15.4559 4.36754C15.1837 3.55086 14.4194 3 13.5585 3H10.4416C9.94243 3 9.47576 3.18519 9.11865 3.5M11.6133 6H20M14 14V17M10 10V17"
                                        stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    ...
    <script>
        ...
        function OpenFlight() {
            const Flightsection = document.getElementById("Flight-data");
            const ClosedIcon = document.getElementById("FlightClosed");
            const OpenIcon = document.getElementById("FlightOpen");

    ...
    <div class="footer__container grid">
        <div class="footer__content grid">
            <div class="footer__data">
                ...
                <p class="footer__description">With Sahla you choose the <br> destination,
            ...
            <div class="footer__data">
                <h3 class="footer__subtitle">Our Pages</h3>
                <ul>
                    <li class="footer__item">
                        <a href="hotels.php" class="footer__link">Hotels</a>
                    </li>
                    <li class="footer__item">
                        <a href="destinations.php" class="footer__link">Locations</a>
                    </li>
                    <li class="footer__item">
                        <a href="Vols.php" class="footer__link">Next Fligths</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="footer__data">
                ...
                <div class="social">
                    ...
                    <div class="Rcard">
                        <svg class="reddit" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="footer__rights">
            <p class="footer__copy">&#169; 2024 Sahla. All rigths reserved.</p>
